...
import com.redbus.config.Configurations;
import com.redbus.utilities.GetDateTime;
import com.redbus.utilities.HTMLReports;
import com.redbus.utilities.Listener;
	...
	public void testScriptSetup(Method itc) throws Exception {
		...
		case "IE":
			...
			if(DriverScript.sIsMaven.equalsIgnoreCase("true"))
			{
				...
				oDriver = new RemoteWebDriver(new URL("http://192.168.33.22:5555/wd/hub"), capabilities);
			}
			else
