...
public class HTMLReports extends Base {
	...
	public void summaryReport() throws IOException{
		try {
			...
			writer.write("<tbody>");
			writer.write("<tr><th width=25%><img src='C:\\Users\\madhusudhan.vaddiboy\\RedBusLogo\\Redbus.png' alt=REDBUS_LOGO height=100></th>");
			...
			while(it.hasNext()){
				...
				writer.write("<td align='center'><img src='C:\\Users\\madhusudhan.vaddiboy\\RedBusLogo\\pass.png' alt='Passed' height='25' width='25'></td>");
	...
	public void detailedReportHeader() throws IOException{
		try {
			...
			writer.write("<th width='25%'><img src='C:\\Users\\madhusudhan.vaddiboy\\RedBusLogo\\Redbus.png' alt=REDBUS_LOGO height='100'></th>");
	...
	public void successReport(String sStepName, String sStepDescription) throws IOException{
		try {
			if(configurations.sScriptPassResult.equalsIgnoreCase("true"))
			{
				...
				if(configurations.sTakeScreenshot.equalsIgnoreCase("true"))
					writer.write("<td><a href="+sPath+".png><img src='C:\\Users\\madhusudhan.vaddiboy\\RedBusLogo\\pass.png' alt='Passed' height='25' width='25'></a></td>");
				else
					writer.write("<td><img src='C:\\Users\\madhusudhan.vaddiboy\\RedBusLogo\\pass.png' alt='Passed' height='25' width='25'></td>");
	...
	public void failureReport(String sStepName, String sStepDescription) throws IOException{
		try {			
			...
			writer.write("<td align='left'>"+" "+sStepName+"</a></td>");
			writer.write("<td align='left'>"+" "+sStepDescription+"</td>");
			writer.write("<td><a href=.\\Screenshots\\"+sFileName+".png><img src='C:\\Users\\madhusudhan.vaddiboy\\RedBusLogo\\fail.png' alt='Failed' height='25' width='25'></a></td>");
			long i = GetDateTime.stepExecutionTime();
			if(i<1)
				i=1;
			writer.write("<td>"+GetDateTime.convertTime(i)+"</td></tr>");
	...
	public void SkippedReport(String sStepDescription) throws IOException{
		try {
			...
			writer.write("<td><img src='C:\\Users\\madhusudhan.vaddiboy\\RedBusLogo\\fail.png' alt='Failed' height='25' width='25'></a></td>");
			long i = GetDateTime.stepExecutionTime();
			if(i<1)
				i=1;
